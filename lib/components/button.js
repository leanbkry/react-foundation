...
exports.Link = exports.Button = exports.addCustomButtonColors = undefined;
...
var ButtonPropTypes = _extends({}, _utils.GeneralPropTypes, {
  color: _react.PropTypes.oneOf((0, _utils.objectValues)(_enums.ButtonColors).concat((0, _utils.objectValues)(CustomButtonColors))),
...
var CustomButtonColors = [];

var addCustomButtonColors = exports.addCustomButtonColors = function addCustomButtonColors(buttonColors) {
  CustomButtonColors = buttonColors;
  ButtonPropTypes.color = _react.PropTypes.oneOf((0, _utils.objectValues)(_enums.ButtonColors).concat((0, _utils.objectValues)(CustomButtonColors)));
};
